...
<div ng-controller="UserController" ng-init='initData(${user})'>
    <div class="panel col-md-4 offset4">
        <div class="panel-heading">
            <h3 class="panel-title"><spring:message code="user.profile"/></h3>
        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="control-group col-md-6">
                        ...
                        <select ng-model="user.country">
                            <option ng-selected="{{country.id == user.country}}"
                    ...
                    <br>
                    <button type="button" class="btn btn-success" ng-click="updateUser(user)">
                        <spring:message code="update.label"/>
                    </button>
                </div>
            </div>
        </div>
